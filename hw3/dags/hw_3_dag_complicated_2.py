...
from util.hw3_functions import download_titanic_dataset_2, pivot_dataset_2, mean_fare_per_class_2
...
with DAG(**default_settings()) as dag:
    ...
    pivot_titanic_dataset = PythonOperator(
        ...
        python_callable=pivot_dataset_2,
        dag=dag,)
    
    mean_fares_titanic_dataset = PythonOperator(
        task_id='mean_fares_dataset',
        python_callable=mean_fare_per_class_2,
        dag=dag,)
