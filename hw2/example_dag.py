...
def mean_fare_per_class():  # ДЗ пп №2
    titanic_df = pd.read_csv(get_path('titanic.csv'))
...
with DAG(
        ...
        schedule_interval='@hourly',  # Периодичность запуска, например, "00 15 * * *"
